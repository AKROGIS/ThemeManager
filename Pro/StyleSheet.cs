...
namespace ThemeManager
{
    class StyleSheet
    {
        ...
        private static XsltArgumentList EsriProcessingArguments()
        {
            ...
            //As of Pro 2.8, this library comes from C:\Program Files\ArcGIS\Pro\bin\Extensions\Metadata
            //and requires .net framework 4.8. It conflicts with the 10.x libraries
            //So, to use this, all the project references (and usings) all need to be changed to the match the Pro SDK
    ...
    class StyleSheetList : List<StyleSheet>
    {
        ...
        private string GetEmbeddedStyleSheetDir()
        {
            ...
            //);
            var styleSheetDir = @"C:\Program Files\ArcGIS\Pro\Resources\Metadata\Stylesheets";
