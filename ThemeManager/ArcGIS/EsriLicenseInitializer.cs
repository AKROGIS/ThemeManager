...
{
    internal sealed class EsriLicenseInitializer
    {
        ...
        //private readonly IAoInitialize m_AoInit = new AoInitializeClass();
        ...
        private bool m_hasInitializeProduct;
        private bool m_hasShutDown;
        ...
        public bool AddExtensions(params esriLicenseExtensionCode[] requestCodes)
        {
            ...
            if (m_hasInitializeProduct)
                return CheckOutLicenses(InitializedProduct);
