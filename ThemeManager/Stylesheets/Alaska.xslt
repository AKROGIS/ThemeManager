...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<!--
	  ...
	  Updated: 2019-06 by Regan Sarwas, NPS AKRO.
	  TODO: Add support for ISO and Esri Metadata formats
	  TODO: Update to modern web standards
	  TODO: Replace GIF with newer PNG, and figure out pathing
	-->
