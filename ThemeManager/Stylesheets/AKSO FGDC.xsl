...
<xsl:template match="/">
  <HTML>
    <HEAD>
      <STYLE>
        <!-- body -->
        BODY {background-color:#F5F5F1; margin:0.25in; 
              font-size:10pt; font-family:Arial,sans-serif}
        <!-- title -->
        H1   {margin-left:0.05in; position:relative; top:-6; text-align:center;
              font-weight:bold; font-size:18; font-family:Verdana,sans-serif; color:#669966}
        <!-- data type -->
        H2   {margin-left:0.25in; position:relative; top:-16; text-align:center;
              font-size:13; font-family:Verdana,sans-serif; color:#CC9966}
        <!-- messaging headers -->
				.M1	{margin-left:0.05in; position:relative; top:-6; text-align:left;
              font-weight:bold; font-size:22; font-family:Verdana,sans-serif; color:#FFFFFF}
				.M2	{margin-left:0.05in; position:relative; top:-6; text-align:right;
              font-weight:bold; font-size:22; font-family:Verdana,sans-serif; color:#FFFFFF}
        ...
        <!-- table cell style 999966 -->
        TD   {font-weight:bold; font-size:11pt; border-color:#996655}
        <!-- selected tab -->
        .tsel  {color:#FFFFFF; background-color:#996655}
        <!-- unselected tab F5F0DD 676769 -->
        .tun   {color:#F5F0DD; background-color:#CC9966}
        <!-- unselected tab hilite -->
        .tover {color:#F5F0DD; background-color:#CC6655; cursor:hand}
        <!-- properties box -->
        .f   {background-color:#FFFFFF; border:'1.5pt solid #996655'; 
              position:relative; top:-10}

        <!-- headings -->
        <!-- group heading -->
        .ph1  {color:#CC6655; font-weight:bold; cursor:none; text-decoration:none}
        <!-- group heading indented CC6655 -->
        .ph2  {margin-left:0.2in; color:#CC6655; font-weight:bold; cursor:none; text-decoration:none}
        <!-- group heading hilite CC9966 -->
        .pover1 {color:#006633; font-weight:bold; cursor:hand; text-decoration:none}
        <!-- group heading hilite indented -->
        .pover2 {margin-left:0.2in; color:#006633; font-weight:bold; cursor:hand; text-decoration:none}

        <!-- values -->
        <!-- property name -->
        .pn  {color:#996655; font-weight:bold}
        <!-- property value -->
        .pv  {font-family:Verdana,sans-serif; line-height:135%; color:#000000; margin:0in 0.15in 0.75in 0.15in}
        <!-- expanded properties -->
        .pe1  {margin-left:0.2in}
        <!-- expanded properties entity indent 002D2D -->
        .pe2  {margin-left:0.25in; font-weight:normal; color:#000000}
        <!-- expanded long text -->
        .lt  {line-height:115%}
        <!-- lists of comma-separated elements -->
        .lt2  {line-height:115%; margin-bottom:1mm}
        <!-- lists of comma-separated elements -->
        .lt3  {font-style:italic; color:#CC9966; line-height:115%; margin-bottom:1mm}
        <!-- indented spatial reference parameters -->
        .sr1  {margin-left:0in}
        .sr2  {margin-left:0.2in}
        .sr3  {margin-left:0.4in}
        .srh1  {color:#CC9966; font-weight:bold; margin-left:0in; text-decoration:none}
        .srh2  {color:#CC9966; font-weight:bold; margin-left:0.2in; text-decoration:none}
        ...
        .sub   {margin-left:0.25in; text-align:center; position:relative; top:3; 
                font-weight:bold; font-size:13; font-family:Verdana,sans-serif; color:#CC9966}
        .search   {margin:0in 0.15in 0.75in 0.15in; 
                   color:#000000; font-family:Verdana,sans-serif; font-size:13}
        .head   {color:#996655}
      </STYLE>
    ...
    <xsl:choose> 
      <xsl:when test="context()[not(metadata)]"> 
        ...
        <xsl:choose> 
          ...
          <xsl:otherwise> 
            <DIV STYLE="text-align:center; color:#996655; margin-left:1in; margin-right:1in">
              <BR/><BR/>
      ...
      <xsl:otherwise> 
        ...
        <TABLE cols="2" frame="void" rules="cols" width="100%" border="0" bgcolor="#000000" cellpadding="3" cellspacing="0">
          <COL WIDTH=""/><COL WIDTH="265"/>
          <TR  valign="top">
            <TD ID="MessageTitle" CLASS="M1" TITLE="Date Set Title">
			        <xsl:value-of select="metadata/idinfo/citation/citeinfo/title"/>
						</TD>
            <TD ID="MessageLogo" CLASS="M2" TITLE="National Park Service"><a href="http://www.nps.gov"><img border="0" src="akso_header_message2.jpg" alt="National Park Service, U.S. Department of the Interior" /></a></TD>
          </TR>
        </TABLE>
				<P></P>
...
-->
            ...
            <xsl:choose>
              <xsl:when test="/metadata[($any$ (idinfo/(citation/citeinfo/
                ...
                <xsl:if test="/metadata[($any$ idinfo/(browse/img/@src) != '') 
                  ...
                  <BR/>
                  <DIV STYLE="text-align:center; color:#996655">_________________</DIV><BR/>
                </xsl:if>
                ...
                <xsl:if test="/metadata/idinfo/keywords
              ...
              <xsl:otherwise>
                <BR/>
                <DIV STYLE="text-align:center; color:#996655">
    ...
    <!-- <CENTER><FONT COLOR="#996655">Metadata stylesheets are provided courtesy of ESRI.  Copyright (c) 2000-2002, Environmental Systems Research Institute, Inc.  All rights reserved.</FONT></CENTER> -->
...
<xsl:template match="/metadata/idinfo/keywords[$any$ */(themekey | placekey | stratkey | tempkey) != '']">
  ...
  <xsl:for-each select="theme[$any$ themekey != '']">
    <DIV CLASS="ph2" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Theme
      ...
      <xsl:for-each select="themekey">
        <xsl:choose>
          <xsl:when test="context()[. = 'REQUIRED: Common-use word or phrase used to describe the subject of the data set.']">
            <SPAN CLASS="lt" STYLE="color:#999999"><xsl:value-of /></SPAN>
          </xsl:when>
          <xsl:otherwise>
            <xsl:choose>
  ...
  <xsl:for-each select="place[$any$ placekey != '']">
    <DIV CLASS="ph2" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Place
			<DIV CLASS="pe2" STYLE="display:">
      <xsl:for-each select="placekey">
        <SPAN CLASS="lt" STYLE=""><xsl:value-of /></SPAN><xsl:if test="context()[not(end()) and . != '']">, </xsl:if>
      </xsl:for-each>
			</DIV>
    </DIV>
  </xsl:for-each>
  <xsl:for-each select="stratum[$any$ stratkey != '']">
    <DIV CLASS="ph2" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Stratum
			<DIV CLASS="pe2" STYLE="display:">
  ...
  <xsl:for-each select="temporal[$any$ tempkey != '']">
    <DIV CLASS="ph2" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Temporal
			<DIV CLASS="pe2" STYLE="display:">
  ...
  <DIV CLASS="ph1" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Status of the data
    <DIV CLASS="pe2" STYLE="display:none">
      ...
      <xsl:for-each select="update[. != '']">
        <SPAN CLASS="lt3">Data update frequency: </SPAN>
        <xsl:choose>
  ...
  <DIV CLASS="ph1" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Time period for which the data is relevant
    <DIV CLASS="pe2" STYLE="display:none">
      ...
      <xsl:for-each select="current[. != '']">
        <DIV>
          <SPAN CLASS="lt3">Description: </SPAN>
          <xsl:choose>
  ...
  <DIV CLASS="ph1" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Publication Information
    <DIV CLASS="pe2" STYLE="display:none"><SPAN CLASS="lt2">
      <xsl:for-each select="origin[$any$ . != '']">
        <xsl:if test="context()[0]"><SPAN CLASS="lt3">Who created the data: </SPAN></xsl:if>
        <xsl:choose>
      ...
      <xsl:if test="context()[(pubdate != '') or (pubtime != '')]">
        <DIV><SPAN CLASS="lt3">Date and time: </SPAN>
          <xsl:choose>
      ...
      <xsl:for-each select="pubinfo[$any$ * != '']">
        <DIV><SPAN CLASS="lt3">Publisher and place: </SPAN>
  ...
  <DIV CLASS="ph1" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Accessing the data
    <DIV CLASS="pe2" STYLE="display:none">
      <xsl:for-each select="digtinfo/formname[. != '']">
        <SPAN CLASS="lt3">Data format: </SPAN><xsl:value-of /><BR/>
      </xsl:for-each>
      <xsl:for-each select="digtinfo/dssize[. != '']">
        <SPAN CLASS="lt3">Size of the data: </SPAN><xsl:value-of /> MB<BR/>
      </xsl:for-each>
      <xsl:for-each select="digtinfo/transize[. != '']">
        <SPAN CLASS="lt3">Data transfer size: </SPAN><xsl:value-of /> MB<BR/>
      </xsl:for-each>
      <xsl:for-each select="digtinfo/filedec[. != '']">
        <SPAN CLASS="lt3">How to decompress the file: </SPAN><xsl:value-of /><BR/>
      </xsl:for-each>
...
<xsl:template match="/metadata/idinfo/accconst[. != '']">
  <SPAN CLASS="lt3">Access constraints: </SPAN>
  <xsl:choose>
...
<xsl:template match="/metadata/idinfo/useconst[. != '']">
  <DIV>
    <SPAN CLASS="lt3">Use constraints: </SPAN>
    <xsl:choose>
...
<xsl:template match="/metadata/metainfo[(metrd != '') or (metfrd != '') or (metstdn != '') or 
  ...
  <xsl:for-each select="metrd[. != '']">
    <DIV><SPAN CLASS="lt3">Contents last reviewed: </SPAN><xsl:value-of /></DIV>
  </xsl:for-each>
  <xsl:for-each select="metfrd[. != '']">
    <DIV><SPAN CLASS="lt3">Contents to be reviewed: </SPAN><xsl:value-of /></DIV>
  </xsl:for-each>
    ...
    <DIV CLASS="ph1" onmouseover="doHilite()" onmouseout="doHilite()" onclick="hideShowGroup(this)">Standards used to create this document
      <DIV CLASS="pe2" STYLE="display:none">
        <xsl:for-each select="metstdn[. != '']">
          <SPAN CLASS="lt3">Standard name: </SPAN><xsl:value-of /><BR/>
        </xsl:for-each>
        <xsl:for-each select="metstdv[. != '']">
          <SPAN CLASS="lt3">Standard version: </SPAN><xsl:value-of /><BR/>
        </xsl:for-each>
        <xsl:for-each select="mettc[. != '']">
          <SPAN CLASS="lt3">Time convention used in this document: </SPAN><xsl:value-of /><BR/>
        </xsl:for-each>
        <xsl:for-each select="metextns[(metprof != '') or (onlink != '')]">
          <xsl:if test="context()[0]"><SPAN CLASS="pn">Metadata profiles defining additonal information:</SPAN></xsl:if>
