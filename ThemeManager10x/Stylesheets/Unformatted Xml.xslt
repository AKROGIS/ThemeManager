...
<!--
  ...
  Modified:   05/21/2001 by Nate Austin (naustin@xxxxxxxxxx)
                         Converted to use XSLT rather than WD-xsl
  Modified by Regan Sarwas 2019-06-15
      converted javascript to modern standard
      e.children(i) ==> e.children[i]
-->
...
<xsl:stylesheet version="1.0"
  ...
  <!--  No XSLT support for the xml declaration (processing instruction (pi))
